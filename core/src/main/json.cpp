...
json::jobject::entry::operator int () const { return this->get_number<int> ("%i"); }
json::jobject::entry::operator unsigned int () const { return this->get_number<unsigned int> ("%u"); }
json::jobject::entry::operator long () const { return this->get_number<long> ("%li"); }
json::jobject::entry::operator unsigned long () const { return this->get_number<unsigned long> ("%lu"); }
json::jobject::entry::operator char () const { return this->get_number<char> ("%c"); }
json::jobject::entry::operator float () const { return this->get_number<float> ("%f"); }
json::jobject::entry::operator double () const { return this->get_number<double> ("%lf"); }

json::jobject::entry::operator std::vector<int> () const { return this->get_number_array<int> ("%i"); }
json::jobject::entry::operator std::vector<unsigned int> () const { return this->get_number_array<unsigned int> ("%u"); }
json::jobject::entry::operator std::vector<long> () const { return this->get_number_array<long> ("%li"); }
json::jobject::entry::operator std::vector<unsigned long> () const { return this->get_number_array<unsigned long> ("%lu"); }
json::jobject::entry::operator std::vector<char> () const { return this->get_number_array<char> ("%c"); }
json::jobject::entry::operator std::vector<float> () const { return this->get_number_array<float> ("%f"); }
json::jobject::entry::operator std::vector<double> () const { return this->get_number_array<double> ("%lf"); }
