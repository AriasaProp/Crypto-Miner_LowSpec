...
JNIF (jboolean, nativeHashing)
(JNIEnv *env, jclass, jlong o, jbyteArray head, jint nonce, jbyteArray target) {
  jbyte *header = env->GetByteArrayElements (head, NULL);
...
JNIF (void, destroyHasher)
(JNIEnv *, jclass, jlong o) {
  delete ((hashing *)o);
}
