...
public class StratumSocket extends Socket {
    ...
    public long submit(int i_nonce, String i_user, String i_jobid, String i_nonce2, String i_ntime) throws IOException {
        ...
        // "79280100"], "id":4}
        this._tx.write("{\"id\": " + id + ", \"method\": \"mining.submit\", \"params\": [\"" + i_user + "\", \"" + i_jobid + "\",\"" + i_nonce2 + "\",\"" + i_ntime + "\",\"" + sn + "\"]}\n");
        this._tx.flush();
        return id;
    }

    final ObjectMapper mapper = new ObjectMapper();
    public JsonNode recvStratumJson() throws IOException {
        return mapper.readTree(this._rx.readLine());
    }
}
